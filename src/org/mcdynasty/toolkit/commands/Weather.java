...
public class Weather {
    ...
    @Command(aliases = {"weather"}, 
    	    usage = "/weather <clear,storm>",
    	    desc = "Changes the current worlds' weather.")
        @CommandPermissions({"toolkit.broadcast"})
        public void weather(final CommandContext args, CommandSender sender) throws CommandException {
